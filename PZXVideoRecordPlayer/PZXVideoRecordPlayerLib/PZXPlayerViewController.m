...
@interface PZXPlayerViewController ()
...
@implementation PZXPlayerViewController
...
//    [self.navigationController dismissViewControllerAnimated:YES completion:nil];
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"代俊傻逼！" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction  *ok =[UIAlertAction actionWithTitle:@"我是" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
